...
def main():
    ...
    config_path = workspace / "hybrid-memory-system" / "v2" / "substrate" / "config" / "default.yaml"

    agent = SubstrateAgent(memory_root, config_path)
    agent.generate = lambda prompt, max_tokens=256: '{"statement": "Knowledge system contains structured and wiki memory layers", "confidence": 0.74, "subject": "knowledge-system"}'
